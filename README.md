...
Vous trouverez le modèle sur *env.template* et *{service}-template.env* que vous aurez besoin de copier dans votre propre fichier *.env* sur votre machine. Affectez ensuite la valeur que vous souhaitez sur chaque variable.
